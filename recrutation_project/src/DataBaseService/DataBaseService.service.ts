...
export class DataBaseServiceService{
    ...
    async addNewTest(newTest: TestDTO): Promise<TestEntity> {
        let createdTest: TestEntity = this.testsRepository.create({
            name: newTest.name,
            choiceQuestions: this.convertChoiceQuestions(newTest.choiceQuestions),
            orderQuestions: this.convertOrderQuestions(newTest.orderQuestions),
            textQuestions: this.convertTextQuestions(newTest.textQuestions),
        });
